...
void readSensors() 
{
  for (int i = 0; i < 8; i++) 
  {
    ...
    Serial.println(lineSensorValue[0]);
    Serial.print("Sensor 7: ");
    Serial.println(lineSensorValue[7]);
}
...
//    bool needToAdjustOutside4 = (lineSensorValue[0] >= colorBlack) || (lineSensorValue[7] >= colorBlack);
